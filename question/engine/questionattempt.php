...
class question_attempt {
    ...
    */
    ...
    /**
     * Returns all QT data for the step most appropriate for use in user
     * feedback. This is typically the most recently graded step.
     *
     * @param array $default The default QT data to be returned, if no step is available.
     */
    public function get_feedback_qt_data($default = array()) {

      // Get the QT data for the step which is most appropriate for creating feedback.
      $step = $this->behaviour->get_feedback_step();
      $qt_data = $step->get_qt_data();
